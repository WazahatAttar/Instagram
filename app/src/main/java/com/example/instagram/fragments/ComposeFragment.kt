    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.btnSubmit).setOnClickListener {
            ...
            if (photoFile != null) {
                ...
                Log.i(MainActivity.TAG, "Failed to take picture")
                //Toast.makeText(this,"You have to take a picture before submitting your post", Toast.LENGTH_SHORT).show()
            }
        }
...
//    Create Post Object
        ...
        post.saveInBackground { exception ->
            if (exception != null) {
                Log.e(MainActivity.TAG, "Send post to the server")
                exception.printStackTrace()
                //Toast.makeText(this, "Send post to the server", Toast.LENGTH_SHORT).show()
            } else {
